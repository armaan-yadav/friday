...
export default function ChatFeed({ transcripts, processing, thinking, partialAi }: Props) {
  ...
  return (
    <main className="relative z-10 flex-1 pt-[110px] pb-52 max-w-[760px] w-full mx-auto px-5 flex flex-col">
      {isEmpty ? (
        <div className="flex flex-col items-center justify-center flex-1 min-h-[50vh] gap-5 text-center">
          ...
          <p className="text-text2 text-sm font-medium tracking-wide">Talk to Friday</p>
          <p className="font-mono text-[0.65rem] uppercase tracking-[0.1em] text-text3">say "hey friday" · or type below</p>
        </div>
      ) : (
        <>
